...
{
    //private readonly ConfigurationRefreshLogger _refreshLogger;

    //public durable(ConfigurationRefreshLogger refreshLogger)
    //{
    ...
    public string SayHello([ActivityTrigger] string name, FunctionContext executionContext)
    {
        ...
        //logger.LogInformation("Saying hello to {name}.", _refreshLogger.TryRefreshAsync());
        return $"Hello {name}!";
    }
